...
if Platform == "linux":
  ## Detect RHEL/CentOS
  if  (platform.linux_distribution[0] == "CentOS Linux") or (platform.linux_distribution[0] == "centos"):
    centos=true
  elif  (platform.linux_distribution[0] == "Red Hat Enterprise Linux Server") or (platform.linux_distribution[0] == "redhat"):
    rhel=true
  else:
    centos=False
  ...
  if  distro.linux_distribution()[0] == "Ubuntu":
    ubuntu=true
  elif  distro.linux_distribution()[0] == "debian":
    debian=true
  else:
    ubuntu=False
    debian=False
...
print(distro.linux_distribution()[0])
...
if not args.executable:
    executable="/opt/ooce/bin/iozone"   
    WindowsEXE='C:\Program Files (x86)\Benchmarks\Iozone3_483\iozone.exe'
    OmniOSEXE="/opt/ooce/bin/iozone"
    TrueNASEXE="/usr/local/bin/iozone"
    CentOSEXE="/usr/bin/iozone"
    UbuntuEXE="/usr/bin/iozone"
else:
