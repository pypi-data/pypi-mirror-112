...
class Entity:
    ...
    Entities are used to index and organize features- a :class:`FeaturePackage`
    ...
    def __init__(
        ...
        *,
        ...
        :param default_join_keys: Deprecated. Use `join_keys`. Names of columns that uniquely identify the entity in FeaturePackage's SQL statement
            for which features should be aggregated for.
        :param join_keys: Names of columns that uniquely identify the entity in FeaturePackage's SQL statement
            for which features should be aggregated for.
    ...
    def with_join_keys(self, join_keys: Union[str, List[str]]) -> "OverriddenEntity":
        ...
        :param join_keys: Names of columns that uniquely identify the entity in FeaturePackage's transformation
            for which features should be aggregated for. Existing `join_keys` will be fully ignored.
