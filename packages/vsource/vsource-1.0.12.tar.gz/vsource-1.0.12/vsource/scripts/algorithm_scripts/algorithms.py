            ...
            with open(os.path.join(self.service_dir, 'vsource_requirements.txt'), 'w') as f:
                for each_requirement in self.requirements:
                    if 'torch==' in each_requirement:
                        ...
                        f.write('http://download.pytorch.org/whl/torch/torch-1.9.0+cpu-cp36-cp36m-linux_x86_64.whl')
                        f.write('\n')
                    elif 'torchvision' in each_requirement:
                        f.write('https://download.pytorch.org/whl/torchvision/torchvision-0.10.0+cpu-cp36-cp36m-linux_x86_64.whl')
                        f.write('\n')
                    else:
