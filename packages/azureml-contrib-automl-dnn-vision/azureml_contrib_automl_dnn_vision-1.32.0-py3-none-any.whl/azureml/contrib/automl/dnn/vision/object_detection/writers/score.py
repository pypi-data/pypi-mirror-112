...
from azureml.contrib.automl.dnn.vision.object_detection.common.constants import MaskToolsLiterals, \
...
def score(training_run_id, device, settings, experiment_name=None, output_file=None,
          root_dir=None, image_list_file=None, ignore_data_errors=True,
