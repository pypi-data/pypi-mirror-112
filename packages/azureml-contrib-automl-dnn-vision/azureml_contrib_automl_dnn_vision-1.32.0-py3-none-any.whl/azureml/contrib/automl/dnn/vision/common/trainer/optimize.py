...
from azureml.contrib.automl.dnn.vision.common import constants, distributed_utils
from azureml.contrib.automl.dnn.vision.common.exceptions import AutoMLVisionSystemException
from azureml.contrib.automl.dnn.vision.common.logging_utils import get_logger
from azureml.contrib.automl.dnn.vision.common.trainer.optimize_parameters import SgdOptimizerParameters, \
...
class BaseOptimizerWrapper(ABC):
    ...
    def __init__(self, model_parameters, settings):
        """
...
class OptimizerFactory:
    ...
    def get_optimizer(self, model, settings):
        """Create an optimizer
...
def setup_optimizer(model, settings):
