...
from azureml.contrib.automl.dnn.vision.common.constants import SettingsLiterals, ScoringLiterals
...
def score(run_id, device, settings, experiment_name=None, output_file=None, root_dir=None,
          image_list_file=None, ignore_data_errors=True,
