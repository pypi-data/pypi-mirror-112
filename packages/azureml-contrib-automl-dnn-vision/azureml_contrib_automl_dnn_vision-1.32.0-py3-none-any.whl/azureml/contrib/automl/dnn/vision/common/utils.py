...
from azureml.automl.core.shared._diagnostics.automl_error_definitions \
    import InsufficientGPUMemory, InsufficientSHMMemory
...
def log_classification_metrics(classification_metrics, computed_metrics,
                               primary_metric, azureml_run, final_epoch=False, best_model_metrics=None):
    """Logs all metrics passed in the dictionary to the run history of the given run.
