...
from azureml.contrib.automl.dnn.vision.common.constants import (
    LrSchedulerType, OptimizerType, SettingsLiterals, ScoringLiterals, TrainingLiterals,
...
def add_task_agnostic_scoring_parameters(parser: ArgumentParser, default_values: dict):
