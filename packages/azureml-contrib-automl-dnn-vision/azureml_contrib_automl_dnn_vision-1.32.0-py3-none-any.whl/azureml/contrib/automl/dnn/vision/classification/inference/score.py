...
from azureml.contrib.automl.dnn.vision.classification.common.classification_utils import \
...
from azureml.contrib.automl.dnn.vision.common.logging_utils import get_logger, clean_settings_for_logging
...
def score(run_id, device, settings, experiment_name=None, output_file=None,
          root_dir=None, image_list_file=None, ignore_data_errors=True, output_dataset_target_path=None,
