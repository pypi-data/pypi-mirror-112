...
class StepLRSchedulerParameters:
    ...
    def __init__(self, settings):
        ...
        self._lr_scheduler_type = settings[TrainingLiterals.LR_SCHEDULER]
        # specific to step lr
        self._step_size = settings[TrainingLiterals.STEP_LR_STEP_SIZE]
        self._gamma = settings[TrainingLiterals.STEP_LR_GAMMA]
...
class WarmUpCosineLRSchedulerParameters:
    ...
    def __init__(self, batches_per_epoch, settings):
        """
        :param settings: dictionary containing settings for training. Currently supported include:
        ...
        self._warmup_steps = batches_per_epoch * settings[TrainingLiterals.WARMUP_COSINE_LR_WARMUP_EPOCHS]
        self._total_steps = batches_per_epoch * settings[TrainingLiterals.NUMBER_OF_EPOCHS]
        self._cycles = settings[TrainingLiterals.WARMUP_COSINE_LR_CYCLES]
