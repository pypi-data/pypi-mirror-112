...
class CConfigPoster(IConfiguration):
    ...
    def _initialize_figure(self) -> figure:
        ...
        """
        l_fig = figure(figsize=(POSTER.FIGUREWIDTH_NARROW, POSTER.FIGUREWIDTH_NARROW))
        ...
        if l_extend == keys.NARROW:
            return figure(figsize=(POSTER.FIGUREWIDTH_NARROW, l_fig_height))
        elif l_extend == keys.BROAD:
            return figure(figsize=(POSTER.FIGUREWIDTH_BROAD, l_fig_height))
        else:
