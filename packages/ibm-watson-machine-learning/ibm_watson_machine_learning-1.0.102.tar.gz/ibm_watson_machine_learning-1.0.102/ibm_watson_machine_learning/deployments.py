...
class Deployments(WMLResource):
    ...
    def get_details(self, deployment_uid=None, serving_name=None, limit=None):
        ...
        if self._ICP and not self._client.ICP_PLATFORM_SPACES:
            if deployment_uid is not None:
                ...
                deployment_details = self._get_artifact_details(url, deployment_uid, limit,
                                                                'deployments', query_params=query_params)
                if "system" in deployment_details:
    ...
    def get_serving_href(deployment_details):
        ...
        try:
            ...
            serving_url = deployment_details['entity']['serving_endpoints'].get(serving_name)
