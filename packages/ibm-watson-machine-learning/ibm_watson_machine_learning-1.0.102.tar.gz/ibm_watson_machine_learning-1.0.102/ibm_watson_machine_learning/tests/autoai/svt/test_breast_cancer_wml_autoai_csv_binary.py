...
class TestAutoAIRemote(unittest.TestCase):
    ...
    def test_03_initialize_optimizer(self):
        TestAutoAIRemote.remote_auto_pipelines = self.experiment.optimizer(
            ...
            autoai_pod_version='!>dev-12-holdout-indices',
    ...
    def test_22b_serving_name_test(self):
        self.wml_client.set.default_space(self.space_id)
        deployment_details = self.wml_client.deployments.get_details(serving_name='test_deployment')
        self.wml_client.deployments.get_serving_href(deployment_details)
