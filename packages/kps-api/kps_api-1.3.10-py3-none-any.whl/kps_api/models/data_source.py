...
import six
from kps_api.models.data_source_field_info import DataSourceFieldInfo  # noqa: F401,E501
...
class DataSource(object):
    ...
    swagger_types = {
        ...
        'connection': 'str',
        'edge_id': 'str',
        'fields': 'list[DataSourceFieldInfo]',
        'id': 'str',
    ...
    def __init__(self, auth_type=None, connection=None, edge_id=None, fields=None, id=None, ifc_info=None, name=None, protocol=None, selectors=None, type=None):  # noqa: E501
    ...
    @property
    def auth_type(self):
        """Gets the auth_type of this DataSource.  # noqa: E501

        Authentication type used by the sensor.  # noqa: E501

        :return: The auth_type of this DataSource.  # noqa: E501
        :rtype: str
        """
    ...
    def auth_type(self, auth_type):
        """Sets the auth_type of this DataSource.

        Authentication type used by the sensor.  # noqa: E501

        :param auth_type: The auth_type of this DataSource.  # noqa: E501
        :type: str
        """
    ...
    def connection(self):
        ...
        Sensor connection type: Secure or Unsecure  # noqa: E501
    ...
    def connection(self, connection):
        ...
        allowed_values = ["Secure", "Unsecure"]  # noqa: E501
    ...
    @property
    def edge_id(self):
        """Gets the edge_id of this DataSource.  # noqa: E501

        ID of the edge this entity belongs to  # noqa: E501

        :return: The edge_id of this DataSource.  # noqa: E501
        :rtype: str
        """
    ...
    def edge_id(self, edge_id):
        """Sets the edge_id of this DataSource.

        ID of the edge this entity belongs to  # noqa: E501

        :param edge_id: The edge_id of this DataSource.  # noqa: E501
        :type: str
        """
        if edge_id is None:
    ...
    @property
    def fields(self):
        """Gets the fields of this DataSource.  # noqa: E501

        User defined fields to extract data from the topic payload.  # noqa: E501

        :return: The fields of this DataSource.  # noqa: E501
        :rtype: list[DataSourceFieldInfo]
        """
        return self._fields

    @fields.setter
    def fields(self, fields):
        """Sets the fields of this DataSource.

        User defined fields to extract data from the topic payload.  # noqa: E501

        :param fields: The fields of this DataSource.  # noqa: E501
        :type: list[DataSourceFieldInfo]
        """
        if fields is None:
    ...
    @property
    def ifc_info(self):
        """Gets the ifc_info of this DataSource.  # noqa: E501


        :return: The ifc_info of this DataSource.  # noqa: E501
    ...
    def ifc_info(self, ifc_info):
        """Sets the ifc_info of this DataSource.


        :param ifc_info: The ifc_info of this DataSource.  # noqa: E501
    ...
    @property
    def protocol(self):
        """Gets the protocol of this DataSource.  # noqa: E501

        Protocol used by the Sensor.  # noqa: E501

        :return: The protocol of this DataSource.  # noqa: E501
        :rtype: str
        """
    ...
    def protocol(self, protocol):
        """Sets the protocol of this DataSource.

        Protocol used by the Sensor.  # noqa: E501

        :param protocol: The protocol of this DataSource.  # noqa: E501
        :type: str
        """
        if protocol is None:
            raise ValueError("Invalid value for `protocol`, must not be `None`")  # noqa: E501
        allowed_values = ["MQTT", "RTSP", "GIGEVISION", "DATAINTERFACE"]  # noqa: E501
    ...
    @property
    def selectors(self):
        """Gets the selectors of this DataSource.  # noqa: E501
        ...
        :return: The selectors of this DataSource.  # noqa: E501
    ...
    def selectors(self, selectors):
        """Sets the selectors of this DataSource.

        A list of DataSourceFieldSelector users assigned to the data source. Allows a user to use Category selectors to identify the data pipeline source. Selectors with different category IDs are combined with the AND operator, while selectors with the same category ID are combined with the OR operator.  # noqa: E501

        :param selectors: The selectors of this DataSource.  # noqa: E501
    ...
    def type(self):
        ...
        Data source type: Sensor or Gateway  # noqa: E501
