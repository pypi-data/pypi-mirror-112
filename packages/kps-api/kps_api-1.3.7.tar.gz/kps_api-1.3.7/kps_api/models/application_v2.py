...
class ApplicationV2(object):
    ...
    def __init__(self, app_manifest=None, data_ifc_endpoints=None, description=None, edge_ids=None, edge_selectors=None, exclude_edge_ids=None, helm_metadata=None, id=None, name=None, only_pre_pull_on_update=None, origin_selectors=None, packaging_type=None, project_id=None, state=None):  # noqa: E501
