...
class _TaskStatus(google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[TaskStatusValue]):
    DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
    TASK_CREATE_STATUS_UNSPECIFIED = typing___cast(TaskStatusValue, 0)
    TASK_CREATE_STATUS_NOT_STARTED = typing___cast(TaskStatusValue, 1)
    TASK_CREATE_STATUS_COMPLETED = typing___cast(TaskStatusValue, 2)
    TASK_CREATE_STATUS_IN_PROGRESS = typing___cast(TaskStatusValue, 3)
    TASK_CREATE_STATUS_WAITING = typing___cast(TaskStatusValue, 4)
    TASK_CREATE_STATUS_DEFERRED = typing___cast(TaskStatusValue, 5)
TASK_CREATE_STATUS_UNSPECIFIED = typing___cast(TaskStatusValue, 0)
TASK_CREATE_STATUS_NOT_STARTED = typing___cast(TaskStatusValue, 1)
TASK_CREATE_STATUS_COMPLETED = typing___cast(TaskStatusValue, 2)
TASK_CREATE_STATUS_IN_PROGRESS = typing___cast(TaskStatusValue, 3)
...
class TaskCreateParams(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        ...
        status : typing___Optional[type___TaskStatusValue] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"timestamp",b"timestamp"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"body",b"body",u"owner_id",b"owner_id",u"status",b"status",u"timestamp",b"timestamp",u"title",b"title"]) -> None: ...
