...
_TASKSTATUS = _descriptor.EnumDescriptor(
  name='TaskStatus',
  full_name='calixa.domain.action.TaskStatus',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='TASK_CREATE_STATUS_UNSPECIFIED', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='TASK_CREATE_STATUS_NOT_STARTED', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='TASK_CREATE_STATUS_COMPLETED', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='TASK_CREATE_STATUS_IN_PROGRESS', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='TASK_CREATE_STATUS_WAITING', index=4, number=4,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='TASK_CREATE_STATUS_DEFERRED', index=5, number=5,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
TASK_CREATE_STATUS_UNSPECIFIED = 0
TASK_CREATE_STATUS_NOT_STARTED = 1
TASK_CREATE_STATUS_COMPLETED = 2
TASK_CREATE_STATUS_IN_PROGRESS = 3
TASK_CREATE_STATUS_WAITING = 4
TASK_CREATE_STATUS_DEFERRED = 5
...
_TASKCREATEPARAMS.fields_by_name['status'].enum_type = _TASKSTATUS
