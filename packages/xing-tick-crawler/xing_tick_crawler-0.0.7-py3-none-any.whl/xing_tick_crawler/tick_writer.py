...
# TODO 파일 한번에 최대 8096개 열 수 있음. 더 열려면..?
...
def write_header(tick_type: DataType, writer: csv.writer) -> None:
    ...
    elif tick_type in [DataType.KOSPI_AFTER_MARKET_TICK, DataType.KOSDAQ_AFTER_MARKET_TICK]:
        writer.writerow(AFTER_MARKET_TICK_COLUMNS)
