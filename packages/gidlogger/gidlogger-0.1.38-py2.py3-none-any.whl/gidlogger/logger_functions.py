...
class CustomFormatter(logging.Formatter):
    ...
    def __init__(self, fmt: Optional[str] = None, datefmt: Optional[str] = None, style='%', validate: bool = True, error_formatter: Callable = None, no_newline_on_error: bool = False) -> None:
