...
class SpellCheck:
    def __init__(self):
        ...
        if not my_file.is_file():
            os.system("cd {}/resource/".format(self.dir_path ))
            os.system("!gdown --id 1GzsIhyArv3SgJmNKzU38_QEuY6lMbq_j")
        self.bigram_lm = self.data_helper.load_var(self.dir_path + "resource/spell/created_bigram.pckl")
        self.onegram_lm = self.data_helper.load_var(self.dir_path + "resource/spell/created_onegram.pckl")
