...
* hammerdb: running hammerdb workload on the following databases: MSSQL, Mariadb, Postgresql on Pod and VM [hammerdb](benchmark_runner/benchmark_operator/templates/hammerdb)
* stressng: running stressng workload on Pod or VM [stressng](benchmark_runner/benchmark_operator/templates/stressng)
* uperf: running uperf workload on Pod or VM  [uperf](benchmark_runner/benchmark_operator/templates/uperf)
