...
def parse_arguments(argsv: str = None) -> argparse.Namespace:
    ...
    run_parser.add_argument(
        "tool_set",
        choices=["seqc", "scata", "sera", "Hashtag", "CellRangerVdj"],  # TODO: Add "CITE-seq"
        help="Choose between `seqc`, `scata`, `sera`, `Hashtag`, or `CellRangerVdj`"
        " to run SeqC, ATAC, Cell Ranger 5` GEX, ATAC, HashTag, or CellRanger V(D)J"
