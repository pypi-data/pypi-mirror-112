...
_LANENEIGHBOR_BOUNDARYSEGMENT = _descriptor.Descriptor(
  name='BoundarySegment',
  full_name='waymo.open_dataset.LaneNeighbor.BoundarySegment',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='lane_start_index', full_name='waymo.open_dataset.LaneNeighbor.BoundarySegment.lane_start_index', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lane_end_index', full_name='waymo.open_dataset.LaneNeighbor.BoundarySegment.lane_end_index', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lane_boundary', full_name='waymo.open_dataset.LaneNeighbor.BoundarySegment.lane_boundary', index=2,
...
_LANENEIGHBOR = _descriptor.Descriptor(
  ...
  nested_types=[_LANENEIGHBOR_BOUNDARYSEGMENT, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_LANECENTER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\020\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='left_neighbors', full_name='waymo.open_dataset.LaneCenter.left_neighbors', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='right_neighbors', full_name='waymo.open_dataset.LaneCenter.right_neighbors', index=7,
...
_LANENEIGHBOR_BOUNDARYSEGMENT.fields_by_name['lane_boundary'].enum_type = _ROADLINE_ROADLINETYPE
_LANENEIGHBOR_BOUNDARYSEGMENT.containing_type = _LANENEIGHBOR
_LANENEIGHBOR.fields_by_name['boundaries'].message_type = _LANENEIGHBOR_BOUNDARYSEGMENT
...
LaneNeighbor = _reflection.GeneratedProtocolMessageType('LaneNeighbor', (_message.Message,), {
  ...
  'BoundarySegment' : _reflection.GeneratedProtocolMessageType('BoundarySegment', (_message.Message,), {
    'DESCRIPTOR' : _LANENEIGHBOR_BOUNDARYSEGMENT,
    '__module__' : 'waymo_open_dataset.protos.map_pb2'
    # @@protoc_insertion_point(class_scope:waymo.open_dataset.LaneNeighbor.BoundarySegment)
    })
  ,
...
_sym_db.RegisterMessage(LaneNeighbor.BoundarySegment)
