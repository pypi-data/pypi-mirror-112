...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.9.0-alpha.1625588847+9ecf88e8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.9.0-alpha.1625588847+9ecf88e8`
                """)
            else:
                raise
