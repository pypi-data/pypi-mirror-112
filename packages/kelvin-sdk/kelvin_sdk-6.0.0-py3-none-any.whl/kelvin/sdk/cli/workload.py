...
def list(acp_name: str, app_name: str, enabled: bool, source: str) -> bool:
    """
...
def deploy(
    ...
    e.g. kelvin workload deploy --app-name "test-app:1.0.0" --acp-name "my-acp" --workload-name "my-new-workload"
