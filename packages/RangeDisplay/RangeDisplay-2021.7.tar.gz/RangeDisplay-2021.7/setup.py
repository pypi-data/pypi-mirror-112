...
setup(
  ...
  version = '2021.7',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/harshvinay752/RangeDisplay/archive/refs/tags/2021.7.tar.gz',    # I explain this later on
