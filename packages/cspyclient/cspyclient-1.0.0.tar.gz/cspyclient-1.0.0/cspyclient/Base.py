...
class Base:
    ...
    def save(self):
        ...
        if not getattr(self, '_id', ''):
            ...
            self.db_service.put(f'/{self.name_of_class}/{self._id}', self.to_json())
    ...
    @classmethod
    def find(cls, page=1, limit=1000, output = 'DataFrame', filter_ = None):
        '''
        ...
        return (Utils.output_form(cls, from_server[name_of_class_camel], output),
               from_server['totalNumber'])
