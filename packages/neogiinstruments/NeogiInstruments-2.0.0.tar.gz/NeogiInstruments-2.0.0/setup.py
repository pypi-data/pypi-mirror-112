...
packages = \
['neogiinstruments', 'neogiinstruments.camera', 'neogiinstruments.rotator']
...
['PyMeasure>=0.9.0,<0.10.0',
 ...
 'elliptec @ git+https://github.com/UNTNeogiLab/TL-rotation-control@master',
 'k10cr1 @ git+https://github.com/QuantumQuadrate/k10cr1@master',
