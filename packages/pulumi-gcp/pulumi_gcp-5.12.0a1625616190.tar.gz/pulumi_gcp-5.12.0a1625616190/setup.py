...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.12.0-alpha.1625616190+5d77a7ed'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.12.0-alpha.1625616190+5d77a7ed`
                """)
            else:
                raise
