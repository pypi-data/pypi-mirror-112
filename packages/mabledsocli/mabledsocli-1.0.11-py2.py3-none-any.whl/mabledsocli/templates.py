...
class TemplateManager():
    ...
    def list(self, stage, uninherited=False):
        ...
        response = provider.list(project, application, stage, uninherited)
    ...
    def add(self, stage, key, contents, render_path):
        ...
        application = Configs.application
        provider = Providers.TemplateProvider()
        Logger.info(f"Start adding template: project={project}, application={application}, stage={Stages.shorten(stage)}, key={key}, render_path={render_path}")
        # if '..' in render_path:
    ...
    def get(self, stage, key, revision=None):
        ...
        application = Configs.application
        provider = Providers.TemplateProvider()
        Logger.info(f"Start getting template contents: project={project}, application={application}, stage={Stages.shorten(stage)}, key={key}")
    ...
    def history(self, stage, key):
        ...
        application = Configs.application
        provider = Providers.TemplateProvider()
        Logger.info(f"Start getting template history: project={project}, application={application}, stage={Stages.shorten(stage)}, key={key}")
    ...
    def delete(self, stage, key):
        ...
        application = Configs.application
        provider = Providers.TemplateProvider()
        Logger.info(f"Start deleting template: project={project}, application={application}, stage={Stages.shorten(stage)}, key={key}")
    ...
    def render(self, stage, limit=''):
        ...
        templates = self.list(stage)['Templates']
