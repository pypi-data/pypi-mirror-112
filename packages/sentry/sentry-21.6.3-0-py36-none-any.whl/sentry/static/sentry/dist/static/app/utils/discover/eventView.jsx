...
import { aggregateOutputType, generateFieldAsString, getAggregateAlias, getEquation, isAggregateEquation, isAggregateField, isEquation, isLegalYAxisType, } from 'app/utils/discover/fields';
...
var EventView = /** @class */ (function () {
    ...
    EventView.prototype.getPerformanceTransactionEventsViewUrlTarget = function (slug, options) {
        ...
        try {
            for (var EXTERNAL_QUERY_STRING_KEYS_3 = __values(EXTERNAL_QUERY_STRING_KEYS), EXTERNAL_QUERY_STRING_KEYS_3_1 = EXTERNAL_QUERY_STRING_KEYS_3.next(); !EXTERNAL_QUERY_STRING_KEYS_3_1.done; EXTERNAL_QUERY_STRING_KEYS_3_1 = EXTERNAL_QUERY_STRING_KEYS_3.next()) {
