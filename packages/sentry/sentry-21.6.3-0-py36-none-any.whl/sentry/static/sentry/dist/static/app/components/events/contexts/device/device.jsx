...
function Device(_a) {
    ...
    var inferredData = getInferredData(data);
    return (<Fragment>
      <ContextBlock data={getDeviceKnownData(event, inferredData, deviceKnownDataValues)}/>
      <ContextBlock data={getUnknownData(inferredData, __spreadArray(__spreadArray([], __read(deviceKnownDataValues)), __read(deviceIgnoredDataValues)))}/>
    </Fragment>);
}
