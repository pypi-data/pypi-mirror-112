...
var VitalsPanel = /** @class */ (function (_super) {
    ...
    VitalsPanel.prototype.renderVitalCard = function (vital, isLoading, error, data, histogram, color, min, max, precision) {
        ...
        {function (results) {
                ...
                return (<VitalCard location={location} isLoading={loading} error={errored} vital={vital} vitalDetails={vitalDetails} summaryData={data} chartData={chartData} colors={color} eventView={eventView} organization={organization} min={min} max={max} precision={precision} dataFilter={dataFilter}/>);
            }}
      </HistogramQuery>);
    };
