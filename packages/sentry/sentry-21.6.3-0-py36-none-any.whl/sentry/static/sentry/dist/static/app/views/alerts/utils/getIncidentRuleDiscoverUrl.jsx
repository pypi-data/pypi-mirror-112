...
export function getIncidentRuleDiscoverUrl(opts) {
    ...
    var discoverQuery = __assign({ id: undefined, name: (rule && rule.name) || '', orderby: "-" + getAggregateAlias(rule.aggregate), yAxis: rule.aggregate, query: (_a = (eventTypeTagFilter || (rule === null || rule === void 0 ? void 0 : rule.query) || eventType)) !== null && _a !== void 0 ? _a : '', projects: projects
            .filter(function (_a) {
            var slug = _a.slug;
