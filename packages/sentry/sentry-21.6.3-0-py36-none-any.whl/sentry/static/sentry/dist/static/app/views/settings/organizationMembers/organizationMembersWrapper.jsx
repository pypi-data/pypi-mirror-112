...
var OrganizationMembersWrapper = /** @class */ (function (_super) {
    ...
    OrganizationMembersWrapper.prototype.renderBody = function () {
        ...
        var action = (<Button priority="primary" size="small" onClick={function () { return openInviteMembersModal({ source: 'members_settings' }); }} data-test-id="email-invite" icon={<IconMail />}>
        {t('Invite Members')}
      </Button>);
        return (<Fragment>
