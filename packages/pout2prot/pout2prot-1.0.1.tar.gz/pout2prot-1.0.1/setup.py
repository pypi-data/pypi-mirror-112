...
LONG_DESCRIPTION = \
    ...
    pout2prot is also available as [an online web application](https://pout2prot.ugent.be) that's run entirely in your 
    browser (you don't need to install anything to get started).
    '''
