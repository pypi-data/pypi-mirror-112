...
/* harmony import */ var _hat_core_renderer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
/* harmony import */ var _hat_core_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var _hat_core_future__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(27);
...
class Application extends EventTarget {
    ...
    constructor(
        ...
        remotePath=null,
        localRpcCbs={},
        renderer=_hat_core_renderer__WEBPACK_IMPORTED_MODULE_1__.default,
        ...
        _hat_core_util__WEBPACK_IMPORTED_MODULE_2__.delay(() => this._connectLoop());
    }
    ...
    _onMessage(msg) {
        if (_hat_core_util__WEBPACK_IMPORTED_MODULE_2__.isObject(msg) && msg.type == 'rpc') {
    ...
    _rpcCall(action, args) {
        ...
        this.send({
            ...
            action: action,
            args: args});
        const f = _hat_core_future__WEBPACK_IMPORTED_MODULE_3__.create();
    ...
    async _connectLoop() {
        while (true) {
            ...
            const closeFuture = _hat_core_future__WEBPACK_IMPORTED_MODULE_3__.create();
            this._conn.addEventListener('close', () => closeFuture.setResult());
            await closeFuture;
            this._conn = null;
            await _hat_core_util__WEBPACK_IMPORTED_MODULE_2__.sleep(this._retryDelay);
        }
    }
...
function main() {
    ...
    viewManager.app = new _hat_core_juggler__WEBPACK_IMPORTED_MODULE_2__.Application('local', 'remote');
...
class ViewManager {
    ...
    async _initView(msg) {
        ...
        const src = _hat_core_util__WEBPACK_IMPORTED_MODULE_1__.get('index.js', msg.view);
        if (!src)
            return;
