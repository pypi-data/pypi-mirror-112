...
f.manual_forecast()
```
- when plotting with silverkite, you need to use an appropriate matplotlib aggregator
  ...
  - see all options here: https://matplotlib.org/stable/tutorials/introductory/usage.html
