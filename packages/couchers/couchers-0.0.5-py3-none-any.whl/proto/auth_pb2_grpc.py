...
class AuthStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SignupTokenInfo = channel.unary_unary(
                ...
                request_serializer=auth__pb2.SignupTokenInfoReq.SerializeToString,
                response_deserializer=auth__pb2.SignupTokenInfoRes.FromString,
                )
        self.CompleteSignup = channel.unary_unary(
                '/org.couchers.auth.Auth/CompleteSignup',
                request_serializer=auth__pb2.CompleteSignupReq.SerializeToString,
...
def add_AuthServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SignupTokenInfo': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=auth__pb2.SignupTokenInfoReq.FromString,
                    response_serializer=auth__pb2.SignupTokenInfoRes.SerializeToString,
            ),
            'CompleteSignup': grpc.unary_unary_rpc_method_handler(
                    servicer.CompleteSignup,
                    request_deserializer=auth__pb2.CompleteSignupReq.FromString,
...
class Auth(object):
    ...
    def SignupTokenInfo(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.couchers.auth.Auth/SignupTokenInfo',
            auth__pb2.SignupTokenInfoReq.SerializeToString,
            auth__pb2.SignupTokenInfoRes.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CompleteSignup(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.couchers.auth.Auth/CompleteSignup',
            auth__pb2.CompleteSignupReq.SerializeToString,
