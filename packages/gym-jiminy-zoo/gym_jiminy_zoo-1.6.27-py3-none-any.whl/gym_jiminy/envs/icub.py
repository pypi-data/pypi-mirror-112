...
class IcubJiminyEnv(WalkerJiminyEnv):
    def __init__(self, debug: bool = False, **kwargs):
        # Get the urdf and mesh paths
        data_root_dir = resource_filename(
            "gym_jiminy.envs", "data/bipedal_robots/icub")
        urdf_path = os.path.join(data_root_dir, "iCubParis02.urdf")
...
IcubPDControlJiminyEnv = build_pipeline(**{
    'env_config': {
        'env_class': IcubJiminyEnv
    },
    'blocks_config': [{
