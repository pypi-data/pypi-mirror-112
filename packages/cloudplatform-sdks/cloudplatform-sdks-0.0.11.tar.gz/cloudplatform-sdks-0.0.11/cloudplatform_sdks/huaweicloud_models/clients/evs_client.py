...
from huaweicloudsdkevs.v2 import EvsClient, CreateVolumeRequest, ListVolumesRequest, ShowJobRequest, DeleteVolumeRequest
...
class HuaweiEvsClient(HuaweiClient):
    ...
    def describe_volume(self, volume_id=None):
        request = ListVolumesRequest(id=volume_id)
