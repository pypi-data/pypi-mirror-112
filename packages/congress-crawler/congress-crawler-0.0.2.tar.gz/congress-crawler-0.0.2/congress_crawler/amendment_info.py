...
from bill_info import action_for
from bill_info import sponsor_for as sponsor_for_bill
...
def process_amendment(amdt_data, bill_id, options):
    ...
    logging.info("[{}] Saving {} to {}...".format(bill_id, amdt["amendment_id"], path))
...
def build_amendment_id(amdt_type, amdt_number, congress):
    return f"{amdt_type}{amdt_number}-{congress}"
