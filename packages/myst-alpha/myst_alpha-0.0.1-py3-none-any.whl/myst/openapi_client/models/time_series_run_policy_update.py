...
from ..models.time_series_run_policy_update_object import TimeSeriesRunPolicyUpdateObject
from ..models.time_series_run_policy_update_type import TimeSeriesRunPolicyUpdateType
from ..types import UNSET, Unset

T = TypeVar("T", bound="TimeSeriesRunPolicyUpdate")


@attr.s(auto_attribs=True)
class TimeSeriesRunPolicyUpdate:
    """Node run policy schema for update requests."""

    object_: Union[Unset, TimeSeriesRunPolicyUpdateObject] = UNSET
    uuid: Union[Unset, str] = UNSET
    create_time: Union[Unset, str] = UNSET
    update_time: Union[Unset, str] = UNSET
    type: Union[Unset, TimeSeriesRunPolicyUpdateType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        object_: Union[Unset, TimeSeriesRunPolicyUpdateObject]
        if isinstance(_object_, Unset):
            object_ = UNSET
        else:
            object_ = TimeSeriesRunPolicyUpdateObject(_object_)
        ...
        type: Union[Unset, TimeSeriesRunPolicyUpdateType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = TimeSeriesRunPolicyUpdateType(_type)
        ...
        time_series_run_policy_update = cls(
            object_=object_,
            uuid=uuid,
        ...
        return time_series_run_policy_update
