...
T = TypeVar("T", bound="TimeDatasetMetadata")


@attr.s(auto_attribs=True)
class TimeDatasetMetadata:
    """User-defined metadata about the time dataset."""

    additional_properties: Dict[str, Union[bool, float, int, str]] = attr.ib(init=False, factory=dict)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_dataset_metadata.additional_properties = additional_properties
        return time_dataset_metadata
