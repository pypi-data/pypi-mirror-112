...
from ..models.time_series_run_policy_get_object import TimeSeriesRunPolicyGetObject
from ..models.time_series_run_policy_get_type import TimeSeriesRunPolicyGetType
from ..types import UNSET, Unset

T = TypeVar("T", bound="TimeSeriesRunPolicyGet")


@attr.s(auto_attribs=True)
class TimeSeriesRunPolicyGet:
    """Node run policy schema for get responses."""

    object_: TimeSeriesRunPolicyGetObject
    uuid: str
    create_time: str
    type: TimeSeriesRunPolicyGetType
    creator: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        object_ = TimeSeriesRunPolicyGetObject(d.pop("object"))

        uuid = d.pop("uuid")

        create_time = d.pop("create_time")

        type = TimeSeriesRunPolicyGetType(d.pop("type"))
        ...
        time_series_run_policy_get = cls(
            object_=object_,
            uuid=uuid,
            create_time=create_time,
            type=type,
        ...
        return time_series_run_policy_get
