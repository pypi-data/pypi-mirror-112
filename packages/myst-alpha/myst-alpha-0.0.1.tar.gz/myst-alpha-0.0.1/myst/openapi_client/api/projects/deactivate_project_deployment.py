...
def _get_kwargs(
    *,
    ...
    url = "{}/projects/{project_uuid}/deployments/{uuid}:deactivate".format(
        client.base_url, project_uuid=project_uuid, uuid=uuid
    )
...
def _parse_response(
    *, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = DeploymentGet.from_dict(response.json())
