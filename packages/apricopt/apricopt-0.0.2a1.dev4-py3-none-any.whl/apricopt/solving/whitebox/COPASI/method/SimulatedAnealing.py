...
class SimulatedAnealing(COPASIOptimisationMethod):
    def __init__(self):
        super(SimulatedAnealing, self).__init__()
        self.solver_parameters = [
            COPASISolverParameter('Start Temperature', 1),
            COPASISolverParameter('Cooling Factor', 0.85),
            COPASISolverParameter('Tolerance', 1e-6)
        ]
