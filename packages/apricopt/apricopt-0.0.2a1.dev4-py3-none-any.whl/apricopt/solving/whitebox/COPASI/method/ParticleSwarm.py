...
class ParticleSwarm(COPASIOptimisationMethod):
    def __init__(self):
        super(ParticleSwarm, self).__init__()
        self.solver_parameters = [
            COPASISolverParameter('Iteration Limit', 2000),
            COPASISolverParameter('Swarm Size', 50),
            COPASISolverParameter('Std. Deviation', 1e-6)
        ]
