...
def build_params_value_dict(black_box: BlackBox, eval_point: PyNomad.PyNomadEvalPoint) -> Dict[str, float]:
...
class NOMADSolver(BlackBoxSolver):
        ...
        def bb(x, dict_given=False) -> int:
            ...
            try:
                ...
                for extreme_barrier_constraint_id in black_box.get_extreme_barrier_constraints_ids():
                    ...
                    if print_bb_evals: print(line, flush=True)
    ...
    def solve(self, black_box: BlackBox, solver_params: list, print_bb_evals=False) -> (Dict[str, float], float, float):
