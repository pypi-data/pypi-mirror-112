...
class HTTPClient:
	...
	async def delete(self, endpoint, **kwargs):
			...
			async with aiohttp.ClientSession().post(self.BASE + endpoint, headers=self.headers, data=data, json=json) as resp:
	...
	async def put(self, endpoint, **kwargs):
			...
			async with aiohttp.ClientSession().put(self.BASE + endpoint, headers=self.headers, data=data, json=json) as resp:
			    return await resp.json()
	...
	async def patch(self, endpoint, **kwargs):
			...
			async with aiohttp.ClientSession().patch(self.BASE + endpoint, headers=self.headers, data=data, json=json) as resp:
			    return await resp.json()				
												
	async def get(self, endpoint, **kwargs):	
			
			async with aiohttp.ClientSession().get(self.BASE + endpoint, headers=self.headers) as resp:
			    return await resp.json()
