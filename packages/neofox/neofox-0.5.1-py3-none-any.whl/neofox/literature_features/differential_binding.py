...
class DifferentialBinding:
    ...
    def get_annotations_mhc2(self, netmhc2pan: BestAndMultipleBinderMhcII) -> List[Annotation]:
        ...
        return [
            ...
            AnnotationFactory.build_annotation(
                value=self.classify_adn_cdn(
                    score_mutation=netmhc2pan.best_mhcII_pan_score, amplitude=amplitude_affinity,
