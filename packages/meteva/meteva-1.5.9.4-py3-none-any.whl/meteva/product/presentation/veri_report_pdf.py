...
if __name__ == '__main__':    
    data_path = r'/Users/linkCM/test/公报转pdf测试数据'    #根目录路径
    doc_path = r'./doc_test01.doc'    #生成word文件路径
    pdf_path = r'./pdf_test01.pdf'    #生成word转pdf文件,pdf不带标签
    pdf_marks_path = r'./pdf_marks01.pdf'    #生成带标签的pdf文件
