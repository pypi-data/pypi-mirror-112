...
class Value(Portable, Searchable):
    ...
    def __init__(self, *args):
        ...
        __init__(Value self, std::int32_t x, bool isVocab=False) -> Value
        __init__(Value self, yarp::conf::float64_t x) -> Value
        __init__(Value self, std::string const & str, bool isVocab=False) -> Value
    ...
    def asVocab(self):
        r"""asVocab(Value self) -> std::int32_t"""
...
def Value_makeVocab(*args):
    r"""
    Value_makeVocab(std::int32_t v) -> Value
...
class QosStyle(object):
    ...
    def getDSCPByVocab(vocab):
        r"""getDSCPByVocab(int vocab) -> yarp::os::QosStyle::PacketPriorityDSCP"""
        return _yarp.QosStyle_getDSCPByVocab(vocab)

    @staticmethod
    def getLevelByVocab(vocab):
        r"""getLevelByVocab(int vocab) -> yarp::os::QosStyle::PacketPriorityLevel"""
...
def QosStyle_getDSCPByVocab(vocab):
    r"""QosStyle_getDSCPByVocab(int vocab) -> yarp::os::QosStyle::PacketPriorityDSCP"""
    return _yarp.QosStyle_getDSCPByVocab(vocab)

def QosStyle_getLevelByVocab(vocab):
    r"""QosStyle_getLevelByVocab(int vocab) -> yarp::os::QosStyle::PacketPriorityLevel"""
    return _yarp.QosStyle_getLevelByVocab(vocab)
