...
from chainer_addons.models.inception import blocks
from chainer_addons.models.inception import link_mappings
...
class InceptionV3(PretrainedModelMixin, chainer.Chain):
	...
	class meta:
		...
		@classmethod
		def prepare_func(cls, x, size=None, swap_channels=True, keep_ratio=True):
			if size is None:
				size = cls.input_size
