...
def check_status_code(request):
    ...
    if int(request.status_code) in [200, 201, 202]:
        ...
        raise exceptions.ForbiddenError("Not allowed to read/write on this element, please check your token or permissions")
        ...
        raise exceptions.UnauthorizedError(request.text)
