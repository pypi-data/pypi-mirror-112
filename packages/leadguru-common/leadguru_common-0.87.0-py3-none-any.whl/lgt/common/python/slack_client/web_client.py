...
def get_slack_credentials(user: UserModel, route: LeadModel, update_expired=True, user_bots=None) -> Optional[
...
def get_dedicated_bot_credentials(user: UserModel, lead: LeadModel, update_expired=True) -> Optional[
    SlackCredentialsResponse]:
