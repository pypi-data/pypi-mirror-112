...
def get_slack_credentials(user: UserModel, route: LeadModel, update_expired=True, user_bots=None,
                          dedicated_bots=None, bots=None) -> Optional[SlackCredentialsResponse]:
    """
    ...
    cred = get_dedicated_bot_credentials(user, route, update_expired, dedicated_bots, bots)
    if cred:
        return cred
...
def get_dedicated_bot_credentials(user: UserModel, lead: LeadModel, update_expired=True,
                                  dedicated_bots=None, bots=None) -> Optional[SlackCredentialsResponse]:
