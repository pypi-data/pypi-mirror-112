...
from grid.exceptions import AuthenticationError, ResourceNotFound, TrainError
...
"""
    ...
    def train(
        ...
        try:
            ...
            if localdir:
                ...
                self._check_dependency_listing(repo_root=str(repository_path))
    ...
    def validate_and_configure_datastore(grid_config: dict):
        ...
        """
        from grid.core import Datastore, Team
