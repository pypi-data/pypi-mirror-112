...
def factorize_module(module, rank, ignore_lower_equal_dim, fact_led_unit, solver, num_iter):
    if type(module) == nn.Linear:
        ...
        if solver == 'svd':
            ...
            ced_module.ced_unit[0].weight.data = u.T.view_as(ced_module.led_unit[0].weight) # Initialize U
            ced_module.ced_unit[1].weight.data = v.T.view_as(ced_module.led_unit[1].weight) # Initialize V
            if module.bias in not None:
