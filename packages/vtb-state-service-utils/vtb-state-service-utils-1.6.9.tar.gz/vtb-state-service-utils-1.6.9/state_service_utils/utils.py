...
if not os.getenv('DEBUG') or not (STATE_SERVICE_MOCK or STATE_SERVICE_TOKEN):
    raise EnvironmentError('`STATE_SERVICE_TOKEN` is required when you`re not using `STATE_SERVICE_MOCK` or debug.')
