...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        :param k: (float) point for calculating the probability density function.

        :return: (float) probability density function output a * b.
        """
    ...
    def __add__(self, other):
        """Function to add together two Binomial PyxDistributions with equal p
