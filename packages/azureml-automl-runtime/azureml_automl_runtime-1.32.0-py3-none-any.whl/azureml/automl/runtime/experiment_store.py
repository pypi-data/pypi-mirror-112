...
class _CVSplitsCollection(MutableMapping[Union[str, int], FeaturizedCVSplit]):
    ...
    This object handles custom read/writes to a muttable mapping allowing
...
class ExperimentData(_CacheableStoreBase):
    ...
    class MaterializedData(_CacheableStoreBase):
        """
        Object contianing materialized data within the ExperimentStore.
        ...
        CV splits are implented through the _CVSplitsCollection object
        which is a cache-backed muttable mapping.
        """
    ...
    class LazyData(_CacheableStoreBase):
        """
        Object contianing lazy data within the ExperimentStore.
