...
class SealController(ServiceInterface):
    def __init__(self, check_result, service_path):
        ...
        self.seal_model_src = path_join(self.data_dir, "verification-tf-serving/model")
        self.seal_model_remote = path_join(self.deploy_dir, "verification-tf-serving/model")
