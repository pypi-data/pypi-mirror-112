...
class FileSystemAccess:
    ...
    def __init_path(path):
        ...
        old_path = expanduser(f'~/.{mycroft.configuration.BASE_FOLDER}/{path}')
        path = expanduser(f'{XDG.xdg_config_home}/{mycroft.configuration.BASE_FOLDER}/{path}')
        core_conf = mycroft.configuration.Configuration.get(remote=False)
