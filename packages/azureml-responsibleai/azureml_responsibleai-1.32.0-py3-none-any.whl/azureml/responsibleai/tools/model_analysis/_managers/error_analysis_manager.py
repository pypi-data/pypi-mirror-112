...
from azureml.responsibleai.common._search_assets import RAIToolAssetType
...
class ErrorAnalysisManager(BaseManager):
    ...
    def list(self) -> List[Dict[str, str]]:
        ...
        self._assets = list(
            self._assets_client.list_assets_with_query(
                ...
                asset_type=RAIToolAssetType.ERRORANALYSIS
            )
        )
    ...
    def download_by_id(self, id: str):
        ...
        return download_error_analysis(run, error_analysis_id)
