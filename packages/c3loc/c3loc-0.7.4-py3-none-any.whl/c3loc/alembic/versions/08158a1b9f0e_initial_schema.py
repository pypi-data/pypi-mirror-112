...
END $$;""")
    ...
    op.execute("CREATE INDEX idx_log_tag_id ON log (tag_id);")
    op.execute("CREATE INDEX idx_log_anchor_id ON log (anchor_id);")
    op.execute("CREATE INDEX idx_log_zone_id ON log (zone_id);")
    op.execute("CREATE INDEX idx_log_ts ON log (ts DESC);")
