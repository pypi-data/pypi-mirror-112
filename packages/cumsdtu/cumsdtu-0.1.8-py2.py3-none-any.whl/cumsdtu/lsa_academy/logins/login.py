...
class Login(BaseResposne):
    ...
    INSIGNIFICANT_KEYS = ['extraValueMap', 'helperData', 'nextStageId', 'paymentDescription', 'saveDeleteRecord',
                          ...
                          'registrationRoundNo',
                          'specialization1', 'specialization2', 'status', 'totalAmount', 'creditsRegistered',
                          'electiveCoursesList',
                          'remainingCredit', 'remainingCourses', 'choiceType', 'countVisible', 'credits',
                          'creditsTypeChoice', 'extraInfo',
...
def test():
    ...
    applicant.username = '2K19/ME/050'
    applicant.password = 'Arzamaan@123'
    ...
    persistor = PersistCookies(r, 'cumsdtu:_{}'.format(applicant.username.replace('/', '_')))
