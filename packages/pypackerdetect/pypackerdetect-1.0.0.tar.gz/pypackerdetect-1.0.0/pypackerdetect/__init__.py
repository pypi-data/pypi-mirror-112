...
class PyPackerDetect:
    ...
    def detect(self, pe, score=False):
        """ Analyze the input PE file for suspicions and/or detections of packers. It has two modes of operation:
            - Report (score=False): report a dictionary of findings with detections and suspicions
            - Decide (score=True):  decide whether the input PE file is packed or not, using a scoring heuristic
        """
