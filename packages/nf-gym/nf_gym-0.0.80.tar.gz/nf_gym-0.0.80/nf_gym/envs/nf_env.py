...
class NFEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if self.debug:
            print("taus",taus)
            print("power",power)
        rews[3]=0.1*(math.exp(-power*0.01)-1) # XXX
        ...
        if self.step_counter==self.max_episode_len:
            ...
            if self.debug:
                ...
                lforce=[r[1] for r in self.all_rews]
                rforce=[r[2] for r in self.all_rews]
                ...
                axs[3][0].plot(lforce,label="lforce")
                axs[3][0].plot(rforce,label="rforce")
