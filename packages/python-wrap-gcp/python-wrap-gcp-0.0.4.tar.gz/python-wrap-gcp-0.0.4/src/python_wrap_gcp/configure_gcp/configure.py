...
class Configure:
    def __init__(self, Path, GCPConfig):
    ...
    def create_template(self, prefix, docker_image, rq_name, cmd, machine_type, container_count=2,
        ...
        def get_startup_script():
            return startup_script.replace('$HOST_IP', self.cnf.HOST_IP
                                                              ...
                                                              f"eu.gcr.io/{self.cnf.GCP_PROJECT}/{docker_image}"
        ...
        query = self.gcp_template.replace('$GCP_PROJECT', self.cnf.GCP_PROJECT
                                               ...
                                               ).replace('$IMAGE', f"eu.gcr.io/{self.cnf.GCP_PROJECT}/{docker_image}"
    ...
    def deploy(self, df, to_skip=('master',)):
    ...
    def configure(self):
        ...
        self.deploy(infrastructure.fillna(''))
