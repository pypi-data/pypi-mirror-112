...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '4.2.0-alpha.1626094857+b24ca816'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 4.2.0-alpha.1626094857+b24ca816`
                """)
            else:
                raise
