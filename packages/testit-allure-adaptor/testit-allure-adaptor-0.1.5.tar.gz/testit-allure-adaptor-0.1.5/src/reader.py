            ...
            if os.path.isdir(args.alluredir):
                ...
                for full_name in full_names:
                    ...
                    if file_extension == '.json':
                        if file_name[-6:] == 'result':
                            ...
                            data_before_after[round(os.stat(args.alluredir + full_name).st_ctime_ns)] = json.load(open(args.alluredir + full_name, encoding='UTF-8'))
                ...
                if file_extension == '.json':
                    if file_name[-6:] == 'result':
                        ...
                        data_before_after[round(os.stat(args.alluredir).st_ctime_ns)] = json.load(open(args.alluredir, encoding='UTF-8'))
