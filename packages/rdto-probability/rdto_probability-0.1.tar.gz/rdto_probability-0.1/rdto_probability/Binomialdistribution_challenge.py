...
class Binomial(Distribution):
    ...
    def plot_histogram_pdf(self):
        ...
        # calculate the values to visualize
        for i in range(n):
            x.append(i)
            y.append(self.pdf(i))
    ...
    # write a method to output the sum of two binomial rdto_probability. Assume both rdto_probability have the same p value.
        
        """Function to add together two Binomial rdto_probability with equal p
        ...
        # TODO: Define addition for two binomial rdto_probability. Assume that the
        # p values of the two rdto_probability are the same. The formula for
        # summing two binomial rdto_probability with different p values is more complicated,
        # so you are only expected to implement the case for two rdto_probability with equal p.
        
        # the try, except statement above will raise an exception if the p values are not equal
        
        # Hint: When adding two binomial rdto_probability, the p value remains the same
        #   The new n value is the sum of the n values of the two rdto_probability.
    ...
    # use the __repr__ magic method to output the characteristics of the binomial distribution object.
        ...
        #
        #       with the values replaced by whatever the actual rdto_probability values are
