...
-   NEW EXTRACTORS: AnimeLab, Philo MSO, Spectrum MSO, Rcs, Gedi,
    ...
    HotstarSeries, VidioPremier, VidioLive, RCTIPlus, TBS Live
...
web (default) or android (force use the android client fallbacks for
video extraction) * player_skip: configs - skip requests if applicable
for client configs and use defaults
