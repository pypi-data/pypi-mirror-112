...
complete --command yt-dlp --long-option extractor-args --description 'Pass these arguments to the extractor. See "EXTRACTOR ARGUMENTS" for details. You can use this option multiple times to give different arguments to different extractors'
