...
setup(
    name='bldsunnyday',  # * Your package will have this name
    ...
    classifiers=['Development Status :: 3 - Alpha',  # Chose either '3 - Alpha', '4 - Beta' or
                 # '5 - Production/Stable' as the current status
