...
if __name__ == '__main__':
    ...
    for sntype in SN.keys():
        savename = f'data/real_ZTF_data_from_osc/ZTF_data_{sntype}_osc-19-Mar-2021_keep_zpt0_objects.pickle'
    ...
    sndata = {}
    for sntype in SN.keys():
        savename = f'data/real_ZTF_data_from_osc/ZTF_data_{sntype}_osc-19-Mar-2020_keep_zpt0_objects.pickle'
