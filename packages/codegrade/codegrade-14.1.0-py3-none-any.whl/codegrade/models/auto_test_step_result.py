...
class AutoTestStepResult:
    ...
    #: step result.
    log: "Optional[Union[CustomOutputLog, JunitTestLog, QualityTestLog, RunProgramLog, IOTestLog, AutoTestStepLogBase]]"
    ...
    data_parser: ClassVar = rqa.Lazy(
        lambda: rqa.FixedMapping(
            ...
            rqa.RequiredArgument(
                ...
                rqa.Nullable(
                    make_union(
                        ParserFor.make(CustomOutputLog),
                        ParserFor.make(JunitTestLog),
                        ParserFor.make(QualityTestLog),
                        ParserFor.make(RunProgramLog),
                        ParserFor.make(IOTestLog),
                        ParserFor.make(AutoTestStepLogBase),
                    )
                ),
                doc=(
