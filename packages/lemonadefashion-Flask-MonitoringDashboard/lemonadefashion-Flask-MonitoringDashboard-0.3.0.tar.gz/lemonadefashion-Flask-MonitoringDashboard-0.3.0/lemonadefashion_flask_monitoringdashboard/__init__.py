...
from lemonadefashion_flask_monitoringdashboard.core.config import Config
...
def bind(app, schedule=True):
    ...
    from lemonadefashion_flask_monitoringdashboard.views import (
        deployment,
        custom,
        endpoint,
        outlier,
    ...
    import lemonadefashion_flask_monitoringdashboard.views

    # Add wrappers to the endpoints that have to be monitored
    from lemonadefashion_flask_monitoringdashboard.core.measurement import init_measurement
    from lemonadefashion_flask_monitoringdashboard.core.cache import init_cache
    from lemonadefashion_flask_monitoringdashboard.core import custom_graph
    ...
    import atexit
    from lemonadefashion_flask_monitoringdashboard.core.cache import flush_cache
