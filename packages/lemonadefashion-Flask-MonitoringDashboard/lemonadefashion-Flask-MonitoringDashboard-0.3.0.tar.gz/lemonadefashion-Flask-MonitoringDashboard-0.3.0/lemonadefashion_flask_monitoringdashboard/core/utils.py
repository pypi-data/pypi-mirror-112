...
from lemonadefashion_flask_monitoringdashboard.core.rules import get_rules
from lemonadefashion_flask_monitoringdashboard.core.timezone import to_local_datetime
from lemonadefashion_flask_monitoringdashboard.database.count import count_requests, count_total_requests
from lemonadefashion_flask_monitoringdashboard.database.endpoint import get_endpoint_by_id
from lemonadefashion_flask_monitoringdashboard.database.request import (
...
def get_details(session):
    ...
    """
    import json
    from lemonadefashion_flask_monitoringdashboard import loc
...
def get_url(end):
    ...
    """
    try:
        return url_for(end, _external=True, _scheme=config.scheme)
    except BuildError:
        return None
