...
- style (dict; optional): jsx Style"""
    ...
    def __init__(self, legendText=Component.UNDEFINED, radiosButtons=Component.UNDEFINED, id=Component.UNDEFINED, value=Component.UNDEFINED, labelPosition=Component.UNDEFINED, orientation=Component.UNDEFINED, disabled=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['legendText', 'radiosButtons', 'id', 'value', 'labelPosition', 'orientation', 'disabled', 'className', 'style']
        self._type = 'RadioButtonGroup'
        self._namespace = 'dash_carbon_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['legendText', 'radiosButtons', 'id', 'value', 'labelPosition', 'orientation', 'disabled', 'className', 'style']
