...
from typing import Mapping, Hashable, TypeVar, Generic, Tuple, MutableMapping, Callable, List
from vespucci.base import Tag, N
...
def sequence(*funcs: Callable[[N], List[N]]) -> Callable[[N], List[N]]:
