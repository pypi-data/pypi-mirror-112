        ...
        while count < retry:
            ...
            try:
                async with self.session.get(
                    ...
                    if "aircons" in data:
                        return data
            except (aiohttp.ClientError, aiohttp.ClientConnectorError, aiohttp.client_exceptions.ServerDisconnectedError, aiohttp.client_exceptions.ClientOSError) as err:
                error = err
    ...
    async def async_change(self, change):
        ...
        async with self.lock:
            while self.changes:
                ...
                except (aiohttp.client_exceptions.ServerDisconnectedError, aiohttp.client_exceptions.ClientOSError) as err:
