...
from signum.core.freq_domain_signal import BaseFreqDomainSignal
...
class BaseTimeDomainSignal(SignalContainer):
    ...
    @staticmethod
    def csd(x, y=None, **kwargs) -> BaseFreqDomainSignal:
        ...
        spectrum = BaseFreqDomainSignal(spectrum, f_resolution=frequencies[1] - frequencies[0], x_start=frequencies[0],
