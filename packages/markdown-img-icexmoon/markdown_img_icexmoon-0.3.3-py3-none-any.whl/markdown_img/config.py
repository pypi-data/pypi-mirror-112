...
class Config():
    ...
    def getCompressInfo(self):
        ...
        #             Config.COMPRESS_INFO_STATUS: "off",
        #             Config.COMPRESS_ENGINE: Config.COMPRESS_ENGINE_GIL}
        # if Config.COMPRESS_ENGINE not in info:
        #     info[Config.COMPRESS_ENGINE] = Config.COMPRESS_ENGINE_GIL
        #     self.setConfigParam(Config.PARAM_COMPRESS, info)
        return info
