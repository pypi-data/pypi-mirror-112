...
class BillingProfileRequestModel(object):
    ...
    def tenant_id(self, tenant_id):
        ...
        if (self.local_vars_configuration.client_side_validation and
                tenant_id is not None and not re.search(r'^[a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12}', tenant_id)):  # noqa: E501
            raise ValueError(r"Invalid value for `tenant_id`, must be a follow pattern or equal to `/^[a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12}/`")  # noqa: E501
    ...
    def subscription_id(self, subscription_id):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                subscription_id is not None and not re.search(r'^[a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12}', subscription_id)):  # noqa: E501
            raise ValueError(r"Invalid value for `subscription_id`, must be a follow pattern or equal to `/^[a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12}/`")  # noqa: E501
