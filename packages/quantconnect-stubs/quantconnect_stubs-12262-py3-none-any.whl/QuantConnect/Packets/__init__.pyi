...
class Controls(System.Object):
    ...
    @property
    def AlternativeDataPermissions(self) -> System.Collections.Generic.HashSet[str]:
        """Gets list of alternative data types permissions"""
        ...

    @AlternativeDataPermissions.setter
    def AlternativeDataPermissions(self, value: System.Collections.Generic.HashSet[str]):
        """Gets list of alternative data types permissions"""
        ...

    @property
    def SecurityTypeDataPermissions(self) -> System.Collections.Generic.HashSet[QuantConnect.SecurityType]:
        """Gets list of security types data permissions"""
        ...

    @SecurityTypeDataPermissions.setter
    def SecurityTypeDataPermissions(self, value: System.Collections.Generic.HashSet[QuantConnect.SecurityType]):
        """Gets list of security types data permissions"""
        ...
