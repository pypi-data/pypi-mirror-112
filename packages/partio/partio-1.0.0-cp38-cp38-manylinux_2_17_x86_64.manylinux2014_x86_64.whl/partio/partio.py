...
class attrNameMap(object):
    r"""Merge two particle sets"""
    ...
    def __init__(self, *args):
        r"""
        __init__(attrNameMap self, std::less< std::string > const & other) -> attrNameMap
        __init__(attrNameMap self) -> attrNameMap
        __init__(attrNameMap self, attrNameMap other) -> attrNameMap
        Merge two particle sets
        """
        _partio.attrNameMap_swiginit(self, _partio.new_attrNameMap(*args))
...
# Register attrNameMap in _partio:
_partio.attrNameMap_swigregister(attrNameMap)
