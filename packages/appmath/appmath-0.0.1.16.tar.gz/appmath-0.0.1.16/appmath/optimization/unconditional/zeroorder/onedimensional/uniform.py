...
time_ = time.time()
unf = ParallelUniformFunction(f, np.array([-1000., 1000.], dtype=np.float64), 200, count_of_iterations_limit=10000,
                              eps=0.00001, workers=8)
unf.predict()
