...
from waveletai._version import VERSION as __version__
...
def download_dataset_artifacts(data_id, destination, unzip=False):
    ...
    """
    global _backend
    return _backend.download_dataset_artifacts(data_id, destination, unzip)
...
def download_feature_zip(feature_id, destination, unzip=False):
    ...
    """
    global _backend
    return _backend.download_feature_zip(feature_id, destination, unzip)
...
def upload_artifact(local_file, artifact_path, run_id):
    ...
    """
    global _backend
    return _backend.upload_artifact(local_file, artifact_path, run_id)
