...
class EquityBrinsonAttribution:
    ...
    def _init_data_param(self):
        ...
        self.equity_ratio_series = self.data_param.get('equity_ratio_series')
...
if __name__ == '__main__':
    attr_result = EquityBrinsonAttribution(
        fund_id='100038', benchmark_id='000300', start_date='20171220', end_date='20210420').get_attribution_result()
