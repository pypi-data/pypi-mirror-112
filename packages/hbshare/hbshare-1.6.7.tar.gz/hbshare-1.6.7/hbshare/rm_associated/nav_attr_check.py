...
if __name__ == '__main__':
    data_ol, data_lc = \
        NavAttributionCheck(fund_id='110011', fund_type='mutual', start_date='20191220', end_date='20210620',
                            factor_type='style', benchmark_id='000985', nav_frequency='day').compare_results()
