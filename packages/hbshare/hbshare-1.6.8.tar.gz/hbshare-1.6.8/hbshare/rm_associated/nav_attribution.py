...
if __name__ == '__main__':
    ...
    res = StyleAttribution(fund_id='110011', fund_type='mutual', start_date='20201220', end_date='20210702',
                           factor_type='style', benchmark_id='000985', nav_frequency='day').get_all(processed=True)
