...
class Resource(root.AbstractMemberObject):
    ...
    @base_path.setter
    def base_path(self, base_path_: Optional[str]) -> None:
        self.__base_path = str(base_path_) if base_path_ is not None else None
    ...
    def file_system_name(self, file_system_name_: Optional[str]) -> None:
        self.__file_system_name = file_system_name_ if file_system_name_ is not None else None
