...
# Raise event on all sessions in the current environment, or on a specific session
def raise_event(name, payload=None, session_id=None):
    anvil.server.call("anvil.private.raise_event", name, payload, session_id=session_id)


def list_client_sessions():
    return anvil.server.call("anvil.private.list_sessions")
