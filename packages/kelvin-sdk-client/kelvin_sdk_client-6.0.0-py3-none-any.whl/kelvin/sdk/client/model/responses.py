...
class Asset(DataModelBase):
    ...
    def list_asset(
        ...
        asset_group_name: Optional[Sequence[str]] = None,
        metadata: Optional[Sequence[str]] = None,
        metadata_filter: Optional[Sequence[str]] = None,
        page_size: Optional[int] = None,
        starting_after: Optional[str] = None,
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        asset_group_name : :obj:`Sequence[str]`
            Filter assets by asset group
        metadata : :obj:`Sequence[str]`
            Inject metadata into the response
        metadata_filter : :obj:`Sequence[str]`
    ...
    def list_asset_type(
        ...
        **Pagination Sortable Columns:** `asset_type.name`, `asset_type.title`, `asset_type.created`, `asset_type.updated`
    ...
    def list_asset_metadata(
        ...
        **Pagination Sortable Columns:** `asset_metadata.name`
    ...
    def list_asset_workloads(
        ...
        """
        List Asset Workloads

        **Permission Required:** `kelvin.permission.asset.read`.

        ``listAssetWorkloads``: ``GET`` ``/api/v4/assets/{asset_name}/workloads/list``
        ...
        result = self_or_cls._make_request(
            client,
            "get",
            "/api/v4/assets/{asset_name}/workloads/list",
            {"asset_name": asset_name},
            {
                "page_size": page_size,
                "starting_after": starting_after,
...
class App(DataModelBase):
    ...
    def list_apps(
        ...
        **Pagination Sortable Columns:** `app.name`, `app.title`, `app.type`, `app.latest_version`, `app.created`, `app.updated`, `app_version.status`
