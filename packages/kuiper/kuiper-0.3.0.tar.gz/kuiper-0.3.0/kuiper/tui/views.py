...
def vforum(TUI):
    ...
    add_center_string(TUI, current_post.title, 1, min_x=border_20_percent, color_pair_index=4)

    # Command bar (spread across comments section bottom)
    commands = ["ENTER = Select", "n = New Post", "a = Account Menu", "p = View My Post", "l = Logout", "h = Help", "ESC = exit"]
