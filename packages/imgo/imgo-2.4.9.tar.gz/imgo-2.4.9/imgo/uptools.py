...
of X (square image data) and y (label data) arrays.
    ...
    Class Attributes:
        ...
        -
        channels (int): number of channels for images in the dataset 
        (1 if B&W, 3 if colour).
        -
...
class Image_Dataset:
    ...
    "various" (str) if the images are not of a consistent size).
    -
    channels (int): number of channels for images in the dataset (1 if
    B&W, 3 if colour)
    -
    ...
    def __init__(
        ...
        self.channels = list(set(channels))[0]
        if (len(set(x_eqdims)) == 1) and (
            len(x_eqdims) - 1 == self.split
        ):
            self.dims = (
