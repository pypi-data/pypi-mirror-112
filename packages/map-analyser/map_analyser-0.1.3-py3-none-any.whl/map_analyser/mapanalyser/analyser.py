...
from .geometry import decompose, convex_hull
...
def filter_areas(areas):
    return [a for a in areas if a.symbol_type in (ml.Symbol.LINE_SYMBOL, ml.Symbol.AREA_SYMBOL, ml.Symbol.COMBINED_SYMBOL)]
