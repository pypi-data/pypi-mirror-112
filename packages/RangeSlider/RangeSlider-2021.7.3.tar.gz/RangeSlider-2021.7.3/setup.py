...
setup(
  ...
  version = '2021.7.3',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/harshvinay752/RangeSlider/archive/refs/tags/2021.7.3.tar.gz',    # I explain this later on
