...
class Ui_SimUI(object):
    def setupUi(self, SimUI):
        ...
        self.cBox_filter = QtWidgets.QCheckBox(SimUI)
        self.cBox_filter.setObjectName("cBox_filter")
        self.hBox_top.addWidget(self.cBox_filter)
    ...
    def retranslateUi(self, SimUI):
        ...
        self.cBox_filter.setText(_translate("SimUI", "filter"))
