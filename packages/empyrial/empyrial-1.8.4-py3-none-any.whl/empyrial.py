...
def optimizer(my_portfolio, method, vol_max=0.15, pie_size=5, font_size=14):
  ...
  if method == "custom":
    wts = optimize(my_portfolio)

  elif method !="EF" and method != "HRP" and method != "MEANVAR" and method != "MINVAR" and method!="EW" and method!="BL" and method!="custom":
    ...
    print('>"custom": Build your own optimizer')
