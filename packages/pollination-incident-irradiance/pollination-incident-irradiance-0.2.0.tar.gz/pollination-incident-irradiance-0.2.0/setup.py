...
setuptools.setup(
    name='pollination-incident-irradiance',                                     # will be used for package name
    ...
    url='https://github.com/pollination/incident-irradiance',                   # will be translated to home
    project_urls={
    ...
    description='Incident irradiance recipe for Pollination.',                  # will be used as package description
    ...
    keywords='honeybee, radiance, ladybug-tools, daylight, incident-irradiance',# will be used as keywords
