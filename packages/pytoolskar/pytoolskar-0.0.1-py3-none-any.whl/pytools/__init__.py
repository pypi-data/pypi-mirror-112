...
def pytoolsprompt():
    ...
    import os
    os.system('cmd.exe /f %USERPROFILE%/AppData/Local/Programs/Python/Python39/Lib/src/pytools/pytprompt.py')

def pyfile(file=''):
    """Runs a python file in a window of PyTools Prompt."""
    import os
    os.system('cmd.exe /f %USERPROFILE%/AppData/Local/Programs/Python/Python39/Lib/src/pytools/pytprompt.py '+file+'.py')
...
def Data(data=''):
    ...
    def StoreData(data_):
        ...
        write("%USERPROFILE%/AppData/Local/Programs/Python/Python39/Lib/pytools/server", data_ + "\n", "txt")
    StoreData(data)

def ClearData():
    """Clears the data from server.txt."""
    overwrite("%USERPROFILE%/AppData/Local/Programs/Python/Python39/Lib/pytools/server", '', 'txt')
...
def GetData():
    ...
    read("%USERPROFILE%/AppData/Local/Programs/Python/Python39/Lib/pytools/server", "txt")
...
from pytools.__MainLib__ import CharacterMap, TofuDetector, TofuDetection, AsciiDetector, AsciiDetection # extensions
