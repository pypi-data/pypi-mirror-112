...
from venvctl.main.venvctl import VenvCtl
from venvctl.utils import utils, configutils
...
class TestMethods(unittest.TestCase):
    ...
    def get_config_file() -> Path:
        ...
        return Path(f'{os.getcwd()}/venvctl/tests/config/venvs.json')
    ...
    def test_g_reports_are_present(self) -> None:
        ...
        for venv in self.get_venvs_config():
            test_is_file = Path(
                f'{target_path}/{venv["name"]}.md').is_file()  # pylint: disable=line-too-long
