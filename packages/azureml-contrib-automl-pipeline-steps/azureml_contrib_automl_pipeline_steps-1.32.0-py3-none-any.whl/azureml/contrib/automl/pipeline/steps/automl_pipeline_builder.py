...
class AutoMLPipelineBuilder:
    ...
    def _build_parallel_run_config_train(
        ...
        if train_env is None:
            ...
            compute_name = compute.name if isinstance(compute, ComputeTarget) else compute
            compute_sku = experiment.workspace.compute_targets.get(compute_name).vm_size
            train_env = jasmine_client.get_curated_environment(scenario=AUTOML_CURATED_ENV_SCENARIO,
