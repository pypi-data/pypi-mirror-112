...
class '''+ Var.nameA[0:-3] +''':
    ...
    def api(self):
        ...
        os.system("curl  http://localhost:4040/api/tunnels > /content/tunnels.json")
        

        try:
            # print("AA",id(self))
            # print(os.path.isfile("/content/tunnels.json"),123)
            with open('/content/tunnels.json') as data_file:
            # pwd = os.getcwd()
            # with open( f'{pwd}/tunnels.json') as data_file:
