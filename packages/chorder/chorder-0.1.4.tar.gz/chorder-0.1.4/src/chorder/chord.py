class Chord:
    ...
    def simple_text(self):
        return f'{self.root()}_{self.quality}'

    def simplify(self):
        return Chord((self.root_pc, Chord.quality_simplify_table[self.quality], self.bass_pc), scale=self.scale)
