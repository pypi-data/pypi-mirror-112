...
class GoogleDrive:
    ...
    def get_gsheet_file_by_id(self, sheet_key, sheet_range):
        ...
        try:
            ...
            self._logger.warning(f"No files or sheet found with id: {sheet_key}")
    ...
    def get_gdrive_csv_by_id(self, sheet_key):
        ...
        try:
            ...
            fh_io = io.BytesIO()
            downloader = MediaIoBaseDownload(fh_io, response, 100 * 1024 * 1024)
    ...
    def convert_drive_io_data_to_df(self, data):
        ...
        self._logger.info(f"Pulled {self.number_of_rows_pulled} rows from drive file")
