...
class IecType:
    ...
    this is just a helper map from *IEC61131* data type to :py:class:`~PyPlcnextRsc.tag_type.RscType`
    """
    Null = RscType.Null
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.Null`"""
    TIME = RscType.IecTime
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.IecTime`"""
    LTIME = RscType.IecTime64
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.IecTime64`"""
    LDATE = RscType.IecDate64
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.IecDate64`"""
    LDATE_AND_TIME = RscType.IecDateTime64
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.IecDateTime64`"""
    LTIME_OF_DAY = RscType.IecTimeOfDay64
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.IecTimeOfDay64`"""
    BOOL = RscType.Bool
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.Bool`"""
    STRING = RscType.Utf8String
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.Utf8String`"""
    LREAL = RscType.Real64
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.Real64`"""
    REAL = RscType.Real32
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.Real32`"""
    LWORD = RscType.Uint64
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.Uint64`"""
    DWORD = RscType.Uint32
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.Uint32`"""
    WORD = RscType.Uint16
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.Uint16`"""
    BYTE = RscType.Uint8
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.Uint8`"""
    LINT = RscType.Int64
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.Int64`"""
    DINT = RscType.Int32
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.Int32`"""
    INT = RscType.Int16
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.Int16`"""
    SINT = RscType.Int8
    """Mapped to :py:const:`PyPlcnextRsc.tag_type.RscType.Int8`"""
