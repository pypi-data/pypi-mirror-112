...
class RscVariant:
    ...
    Create a RscVariant object by providing both the definite :py:class:`~PyPlcnextRsc.tag_type.RscType` and python value

    :param value: Python value which to be wrapped in.
    :param rscType: the definite type of the value.

                    .. note::
                        If you are just make RscVariant object mapped to *IEC61131*, use :py:class:`~PyPlcnextRsc.tag_type.IecType` is more concrete

    :type rscType: :py:class:`~PyPlcnextRsc.tag_type.RscType`
    """
    ...
    def of(cls, value):
        """
        Create RscVariant from some special python object that :py:class:`~PyPlcnextRsc.tag_type.RscType` is clearly to tell from

            .. warning::
                This is not suitable for some value that is ambiguous , for example you give number 100 use this method,
                but for this method it is not possible to know which `INT` (or in other word, which :py:class:`~PyPlcnextRsc.tag_type.RscType`)you are talking about:
                it shell be :py:const:`PyPlcnextRsc.tag_type.RscType.Uint8` ? :py:const:`PyPlcnextRsc.tag_type.RscType.Int16` ? or :py:const:`PyPlcnextRsc.tag_type.RscType.Int64` ...?

                So in this case, you must use :py:func:`~PyPlcnextRsc.common.objects.rsc_variant.RscVariant.__init__` to give the :py:class:`~PyPlcnextRsc.tag_type.RscType` explicitly.

        - bool value : the :py:const:`PyPlcnextRsc.tag_type.RscType.Bool` will be filled
        - str value : the :py:const:`PyPlcnextRsc.tag_type.RscType.Utf8String` will be filled
        - :py:class:`~PyPlcnextRsc.common.objects.rsc_sequence.RscTuple` or :py:class:`~PyPlcnextRsc.common.objects.rsc_sequence.RscList` : the :py:const:`PyPlcnextRsc.tag_type.RscType.Array` will be filled
        - :py:class:`~PyPlcnextRsc.common.objects.rsc_struct.RscStructMeta` or :py:class:`~PyPlcnextRsc.common.objects.rsc_struct.RscStructBuilder` :the :py:const:`PyPlcnextRsc.tag_type.RscType.Struct` will be filled
    ...
    def GetValue(self) -> any:
        ...
        :return: any python value that represent the corresponding value from PLC
                ...
                ..  note::
                    Special case of :py:class:`~PyPlcnextRsc.tag_type.RscType`

                    - :py:const:`PyPlcnextRsc.tag_type.RscType.Array` : the value type might be :py:class:`~PyPlcnextRsc.common.objects.rsc_sequence.RscList`
                    - :py:const:`PyPlcnextRsc.tag_type.RscType.Struct`: the value type might be :py:class:`~PyPlcnextRsc.common.objects.rsc_struct.RscStructMeta`
    ...
    def GetType(self) -> RscType:
        """
        Get the :py:class:`~PyPlcnextRsc.tag_type.RscType` corresponding to the contained value.
