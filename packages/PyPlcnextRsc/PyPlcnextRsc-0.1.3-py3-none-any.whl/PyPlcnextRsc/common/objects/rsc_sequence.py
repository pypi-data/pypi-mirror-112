...
class RscSequence:
    ...
    def setElementRscType(self, rscType: RscType):
        """
        Configure the sequence by passing in primitive type (:py:class:`~PyPlcnextRsc.tag_type.RscType`)
    ...
    def getElementRscType(self) -> RscType:
        """
        Get the :py:class:`~PyPlcnextRsc.tag_type.RscType` of the element.

        :return: the :py:class:`~PyPlcnextRsc.tag_type.RscType` of the element.
        :rtype: RscType
...
class RscList(list, RscSequence):
    ...
    def __setitem__(self, key, value):
        return super().__setitem__(self.__applyOffset(key), value)
    ...
    def createNextDimension(self, elementRscType: RscType, count: int, reserve: int = 0, default: any = None):
        ...
        :param elementRscType: :py:class:`~PyPlcnextRsc.tag_type.RscType` of the element
        :type elementRscType: :py:class:`~PyPlcnextRsc.tag_type.RscType`
    ...
    def __eq__(self, other):
        """
        Overload the list.__eq__, now must the other element's :py:class:`~PyPlcnextRsc.tag_type.RscType`
...
class RscTuple(tuple, RscSequence):
    ...
    def __eq__(self, other):
        """
        Overload the tuple.__eq__, now must the other element's :py:class:`~PyPlcnextRsc.tag_type.RscType`
        same with self's element type is possible to return True
