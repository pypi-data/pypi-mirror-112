...
class DeviceSettingResult(RscStruct):
    ...
    """
    The value for the requested setting which can be RscType::Void and otherwise is of the simple type the setting has.
    Please note that this property is RscType::Void whenever the member :py:attr:`~PyPlcnextRsc.Arp.Device.Interface.Services.DeviceSettingResult.ErrorCode`
...
class IDeviceInfoService:
    ...
    def GetItem(self, identifier: RscString512) -> RscVariant:
        ...
        :return: value as RscVariant on success, :py:const:`PyPlcnextRsc.tag_type.RscType.Void` on error
        :rtype: RscVariant
    ...
    def GetItems(self, identifiers: RscTpSequence[RscString512]) -> RscTpTuple[RscVariant]:
        ...
        :return: values as RscVariant on success, :py:const:`PyPlcnextRsc.tag_type.RscType.Void` on error
