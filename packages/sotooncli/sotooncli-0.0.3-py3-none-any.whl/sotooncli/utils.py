...
def read_yaml_file(path):
    try:
        ...
        raise click.ClickException(ERROR_LOAD_FILE.format(path=path, error=get_strerror(e)))
...
def write_to_yaml(path, value):
    try:
        ...
        raise click.ClickException(ERROR_WRITE_TO_FILE.format(path=path, error=get_strerror(e)))
