...
class OfficeCaltech(DatasetFolder):
    ...
    Parameters:
        ...
        - **domain** (str): The domain to create dataset. Choices include ``'A'``: amazon, \
    ...
    def __init__(self, root: str, domain: str, download: Optional[bool] = False, **kwargs):
        ...
        super().__init__(
            os.path.join(root, self.directories[domain]), default_loader, extensions=IMG_EXTENSIONS, **kwargs)
