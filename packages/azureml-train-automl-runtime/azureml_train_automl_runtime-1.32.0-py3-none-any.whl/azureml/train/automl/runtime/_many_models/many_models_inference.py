...
class ManyModelsInference:
    ...
    def __init__(self,
        ...
        :param forecast_quantile: Inference using forecast_quantile
        """
        ...
        print("forecast_quantiles: {}".format(self.forecast_quantiles))
    ...
    def _do_inference(self, data: DataFrame) -> DataFrame:
        ...
        if self.forecast_quantiles:
            print('Inference using forecast quantiles')
            model.quantiles = self.forecast_quantiles
            y_predictions = model.forecast_quantiles(
            ...
            print('Inference using forecast')
