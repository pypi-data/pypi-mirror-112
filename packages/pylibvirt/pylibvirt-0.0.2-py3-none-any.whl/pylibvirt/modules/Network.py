...
class Network(Device):
    ...
    def __init__(self, name: str, mode: str or bool = "nat", domain: str = "network", ip4_cidr: str = None,
                 dhcp_start: str = None,
                 dhcp_stop: str = None):
        """
        Create virtual network
        :param name: name of the network, must be unique
        :param mode: Type of network, values can be nat, route, open, hostdev and False for isolated network
        :param domain: DNS domain name to use, default is network
        :param ip4_cidr: Optional parameter to set the ip configuration: eg: 192.168.1.0/24
        :param dhcp_start: Optional parameter to activate dhcp set start address and stop address. eg: 192.168.1.2
        :param dhcp_stop: Optional parameter to activate dhcp set start address and stop address. eg: 192.168.1.20
        """
