...
class GraphicDevice(Device):
    ...
    def __init__(self, graphic_type: str = "spice", port: int = -1, tls_port: int = -1, password: str = None,
                 image_compression: str = 'off', open_gl: bool = False, render_node: str = "", listen: str = "address"):
