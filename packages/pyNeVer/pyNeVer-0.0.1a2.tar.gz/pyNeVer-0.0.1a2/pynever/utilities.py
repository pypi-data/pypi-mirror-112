...
def never2smt(prt: ver.NeVerProperty, input_prefix: str, output_prefix: str, filepath: str):
...
def temp_never2smt(prt: ver.NeVerProperty, input_prefix: str, output_prefix: str, filepath: str):
