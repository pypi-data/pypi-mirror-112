...
class CoinMarketCap(BaseSource):
    ...
    def fetch(self, series):
        ...
        prices = []
        # TODO handle when data has no "quotes" key (e.g. base symbol not found)
    ...
    def _data(self, series):
        ...
        # TODO handle base id or quote symbol not found ->
        #      HTTP 400 and JSON body but no "data" key
    ...
    def _output_pair(self, base, quote, data):
        # TODO handle data["quotes"] is an empty object (e.g. XXX/AUD -s 2021-06-25)
