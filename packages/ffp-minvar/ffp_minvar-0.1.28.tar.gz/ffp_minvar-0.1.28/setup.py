...
shared_lib = os.path.join('ffp_minvar', "alg_lomv")
...
class CustomInstall(install):
    def run(self):
        # delete all .so file inside the package directory
        cwd = os.getcwd()
        cwd_so_files = glob.glob("*.so")
        for file in cwd_so_files:
