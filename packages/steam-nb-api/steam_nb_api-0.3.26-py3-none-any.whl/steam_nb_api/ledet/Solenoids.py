...
class Solenoid_magnet:
    def __init__(self, magnet_name):
        ...
        self.Is = np.concatenate([np.ones_like(sol.Rin)*self.magnet_data['Iref'] for sol in pysol_data], axis=None)
        ...
        for block in pysol_data:
            ...
            currents.append(np.ones(block.tot_n_turns) * self.magnet_data['Iref'])
