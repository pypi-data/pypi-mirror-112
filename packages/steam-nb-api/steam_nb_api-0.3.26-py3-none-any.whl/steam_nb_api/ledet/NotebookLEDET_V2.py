...
class Notebook_LEDET:
    ...
    def _setUp_Solenoid(self, recalc_field):
        ...
        self.Solenoid.save_B_map(self.out_dir)
    ...
    def _solenoid_locals(self):
        ...
        #magnet_data = read_yaml('circuit', magnet_data['circuit'])
        #magnet_data = read_yaml('protection', magnet_data['protection'])

        R_EE_triggered = (magnet_data['U_EE'] - self.Magnet.Inputs.I00 * (
                magnet_data['R_circuit'] + magnet_data['R_crowbar']) - magnet_data['Ud_crowbar']) / self.Magnet.Inputs.I00  # Resistance of the energy-extraction system [Ohm]
        if R_EE_triggered < 0:
            R_EE_triggered = 0
        ...
        self.Magnet.Inputs.t_PC_LUT = [sim_start, magnet_data['t_PC'], magnet_data['t_PC'] + 0.01]
        dict_block = {
