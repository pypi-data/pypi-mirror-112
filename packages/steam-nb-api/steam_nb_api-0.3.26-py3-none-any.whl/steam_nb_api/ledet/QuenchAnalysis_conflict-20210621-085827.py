...
class QuenchPlanAnalysis():
    ...
    def PrepareSimulation_FromMeasurements(self, RefFile, OutputDirectory, MagnetName = '', CoilCsv = '', ROXIE = '',
        ...
        if self.TDMSdata.Quenches.size > 0:
            if str(self.TDMSdata.Quenches[0,0]) == str(self.TDMSdata.Quenches[0,0]):
                cont = 0
                if ROXIE:
    ...
    def ExtractFeatures(self, SIM= 1, TDMS=1):
        ...
        if TDMS:
            self.TDMSdata.t_PC = self.TDMSdata.TimeFrame_MF[self.TDMSdata.trigger_PC+1, 0]
