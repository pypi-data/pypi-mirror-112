...
class DataTreatment:
    ...
    def exec_treatment(self):
        ...
        if self.method == "Johnson_rank":
            ...
            if not self.stress or not isinstance(self.stress, Sample):
                raise ValueError("Parameter 'stress' is incorrect. Please enter a DataTreatment instance, for further information go to help(DataTreatment).")
    ...
    def weibayes(self):
        ...
        Just for Weibull law (for the moment)
        """
