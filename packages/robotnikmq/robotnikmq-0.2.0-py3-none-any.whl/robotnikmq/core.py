...
from typing import Optional, Callable, Any, Dict, Union, Generator
...
class Robotnik:
    ...
    def open_channel(self) -> Generator[BlockingChannel, None, None]:
        _ch = self._open_channel()
        yield _ch
        self._close_channel(_ch)
    ...
    @staticmethod
    @typechecked
    def _close_channel(channel: BlockingChannel) -> None:
