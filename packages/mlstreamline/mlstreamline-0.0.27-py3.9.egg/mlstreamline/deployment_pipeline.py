...
from mlstreamline.transformers.gaussian_mixture_transformer import GaussianMixtureTransformer
...
class DeploymentPipeline:
    def __init__(self, config, pipeline_path=None, classifier=None, data=None):
        ...
        self.required_configs = ['predictor_columns', 'numeric_features', 
                                 ...
                                 'no_transform_columns', 'gaussian_components',
    ...
    def check_configs(self):
        columns_check = self.config['numeric_features'] + \
                ...
                self.config['gaussian_mixture_features'] + \
    ...
    def construct_preprocessor(self):
        ...
        gaussian_mixture_transformer = Pipeline(steps=[
                        ('imputer', SimpleImputer(strategy='most_frequent')),
                        ('gaussian_mixture_transformer', GaussianMixtureTransformer(self.config['gaussian_components']))
                ])
        ...
        transformers = [
                            ...
                            ('gaussian_mixture_transformer', gaussian_mixture_transformer, self.config['gaussian_mixture_features']),
