import click
from jijzept.config.handle_config import HOST_URL, CONFIG_PATH, DEFAULT_CONFIG_FILE, create_config
...
@main.command()
def show():
    click.echo("JijZept's default configuration path: {}".format(CONFIG_PATH + DEFAULT_CONFIG_FILE))
