...
setup(
    name="OnlineWorks",
    version="0.0.6",
    description="A simple python pacakage that helps you to perform sevaral online tasks and Computer Automations.",
