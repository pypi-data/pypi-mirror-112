...
class ModelWorkloadEdges(object):
    ...
    def __init__(self, access_token=None, billing_histories=None, created_by=None, histories=None, kernel_cluster=None, kernel_cluster_node=None, kernel_image=None, kernel_resource_spec=None, organization=None, project=None, local_vars_configuration=None):  # noqa: E501
