...
def main(arg):
    ...
    #id 9OuOfYM2QZRhmUug
    #secret gw<Nl6bc2Ib,VX&)c2U{mX1?d_zEg0^d


    junopy.Juno('4E1574938F3DD69306BC336E348276ACC9CBE72B4E8396B2520436663C66C08E', '9OuOfYM2QZRhmUug', 'gw<Nl6bc2Ib,VX&)c2U{mX1?d_zEg0^d')

    transfer = junopy.transfers.Default(10.0)

    print(transfer)
    print(transfer.toJSON())


    #juno.GetToken('9OuOfYM2QZRhmUug', 'gw<Nl6bc2Ib,VX&)c2U{mX1?d_zEg0^d')
