...
parser = argparse.ArgumentParser(description="""Save a file or directory in git and upload it.
...
parser.add_argument('-r',
                    ...
                    required=False,
                    default="origin")
parser.add_argument('file_or_directory', help='The file or directory to update')
