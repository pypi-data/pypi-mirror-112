...
parser = argparse.ArgumentParser(description="""Donwload and reset a file or directory from git.
...
parser.add_argument('-r',
                    ...
                    required=False,
                    default="origin")
parser.add_argument('file_or_directory', help='The file or directory to reset')
...
if __name__ == "__main__":
    ...
    if run("""git cat-file -t "{}" """.format(hash)) == "tree":
        ...
        open(name, "wb").write(run("""git cat-file blob "{}" """.format(hash), strip=False).encode("utf-8"), )
