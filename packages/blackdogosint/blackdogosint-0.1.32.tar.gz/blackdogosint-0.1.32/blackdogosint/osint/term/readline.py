...
from blackdogosint.osint.term import keyconsts as kc
from blackdogosint.osint.term import keymap as km
from blackdogosint.osint.term import term, text
...
def readline(_size=-1, prompt='', float=True, priority=10):
    ...
    from blackdogosint.osint.term import term_mode
    if not term_mode:
...
def eval_input(prompt='', float=True):
    ...
    Example:
        ...
        Favorite object? 20
    """
    from blackdogosint.osint.utils import safeeval
