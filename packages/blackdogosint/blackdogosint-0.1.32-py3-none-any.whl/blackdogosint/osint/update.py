...
from blackdogosint.osint.config import register_config
from blackdogosint.osint.context import context
from blackdogosint.osint.log import getLogger
from blackdogosint.osint.utils.misc import read
from blackdogosint.osint.utils.misc import write
from blackdogosint.osint.version import __version__
...
def perform_check(prerelease=current_version.is_prerelease):
    ...
    >>> from blackdogosint.osint.update import current_version
    ...
    >>> from blackdogosint.osint.update import available_on_pypi
