"""
Functions for creating a 2D partial plot of an Abzu model.
"""
...
def plot_partial2d(
    ...
    Keyword Arguments:
        fixed {Optional[Dict[str, Union[int, float]]]} -- Dictionary with values we fix in the model. The key is a feature name in the model and the value is a number that the feature is fixed to. (default: {None})
