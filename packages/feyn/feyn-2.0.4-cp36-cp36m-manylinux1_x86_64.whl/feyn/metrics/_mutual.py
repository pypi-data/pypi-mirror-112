...
def calculate_mi(rv_samples:Iterable[Iterable], float_bins:int=100) -> float:
    """
    Numpy-based implementation of mutual information for n random variables. This can be used for both categorical (discrete) and continuous variables, you can as many as you want of each, in any position in the iterable.
