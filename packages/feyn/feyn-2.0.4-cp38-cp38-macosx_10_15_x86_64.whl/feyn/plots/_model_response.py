...
def plot_model_response_1d(
    ...
    # Determine ordering of axes depending on type
    ...
    if is_categorical:
        ...
        ticks_loc = np.linspace(0., 1., len(by_input))
    ...
    ### End Computation and data readying ###

    ### Initialization ###
    # Determine layout (the raw skeleton of the plot)
    if ax is None:
    ...
    ### Updating the plot with the data ###
    # Only rendering - Updating the plots with the right data (+ linestyles etc.)
